...
export interface PurchaseOrderData {
    ...
    expectedDate: Date;
    salesOrderId?: string;
    // FIX: Add optional 'orderDate' property to allow passing it from the creation form.
...
export interface LayawayPayment {
  ...
  date: Date;
  amount: number;
  // FIX: Added 'Points' to align with the Payment type and resolve a TypeScript error in App.tsx.
  method: 'Cash' | 'M-Pesa' | 'Card' | 'Points';
  cashierId: string;
}
...
export interface AccountingTransaction {
    ...
    referenceType: 'Sale' | 'Return' | 'Expense' | 'Supplier Payment' | 'Stock Receipt' | 'Bank Deposit';
